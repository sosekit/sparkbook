...
These photos are supplied project assets for the sparks prototype demo. They are bundled into `demoMediaLibrary.ts` and reused by seeded sparks, lists, and the create-spark media picker.
