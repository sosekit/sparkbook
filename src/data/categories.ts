import { SparkCategory } from '../types/spark';

export const categories: SparkCategory[] = [
  { id: 'food', name: 'Food', iconKey: 'food', color: '#2E5BAD', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'coffee', name: 'Coffee', iconKey: 'coffee', color: '#7BA3E0', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'dessert', name: 'Dessert', iconKey: 'dessert', color: '#4E6585', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'study', name: 'Study', iconKey: 'study', color: '#4E6585', createdAt: '2026-01-01T00:00:00.000Z' },
